...
class LoginPage:
    ...
    def check_links_for_terms_and_privacy(self):
        x = self.driver.find_element(By.CSS_SELECTOR,'div.Login_firstContainerContent__wbbdK > form > p > a:nth-child(1)').get_attribute('href')
        print(x)
    ...
    def press_recover_password_button(self):
        self.driver.find_element(By.CSS_SELECTOR,'div.Login_firstContainerContent__wbbdK > div > button > div > div > p').click()
